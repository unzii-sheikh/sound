    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-event-area mb-30 shadow-lg" style="border-radius: 10px; overflow:hidden; background:#fff;">

                    <!-- Artist Image -->
                    <div class="event-thumbnail">
                        <img src="uploads/{{$art->artistsfile}}" 
                             style="width:100%; height:250px; object-fit:cover;">
                    </div>

                    <!-- Artist Content -->
                    <div class="event-text p-3">
                        <h2 class="text-light">{{ $art->artistname}}</h2>
                        <h5 class="text-light">{{ $art->genresname }}</h5>
