        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-9">
                <div class="ablums-text text-center mb-70">
                    <p>The latest albums making waves across the music world showcase an exciting blend of creativity, fresh sounds, and bold artistic direction. From soulful R&B and dynamic pop projects to experimental rock and hard-hitting hip-hop releases, artists are pushing their boundaries and offering listeners something truly new. Established musicians are returning with highly anticipated projects,</p>
                </div>
            </div>
        </div>
            ...
            @if($aud->musictype == 'Audio')
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="uploads/{{$aud->thumbnail}}" class="card-img-top rounded" style="height: 400px; object-fit: cover;" width="100%">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-1">{{$aud->musicname}}</h5>
                            <hr>
                            <h5 class="card-title mb-1">{{$aud->artistname}}</h5>
                            <hr>
                            <b><p class="card-subtitle text-muted mb-2">{{$aud->albumname}}</p></b>
                            
                            <hr>
                            <audio controls class="w-100">
                                <source src="uploads/{{$aud->musicfile}}" type="audio/mpeg">
                ...
                <div class="featured-artist-content">
                    ...
                    <div class="song-play-area">
                        ...
                        <audio preload="auto" controls>
                            <source src="public/audio/dummy-audio.mp3">
                        </audio>
                    </div>
                </div>
            </div>
